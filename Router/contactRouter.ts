...
import { addContactToFavorites, createNewContact, deleteOneContact, findByFavs, findByLabel, findContacts, findOneContact, findOneContact2, updateContactAvatar, updateContactInfo } from "../Controller/contactsController"
...
router.route("/:contactID/update-contact-info").patch(updateContactInfo)
